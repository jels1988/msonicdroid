...
public class ConsultarClienteActivity extends ListActivityBase {
	...
	public static class EfficientAdapter extends BaseAdapter implements
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				convertView = mInflater.inflate(
						R.layout.consultarclientered_content, null);
				...
				holder.imgConsultarEncuesta = (ImageButton) convertView.findViewById(R.id.btn_encuesta);
			...
			if (cliente.isEquiposFrio()) {
				...
				holder.imgEquipoFrio.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						consultarEquipoFrioActivity.putExtra(ProfitHistoryActivity.CODIGO_CLIENTE_KEY,clienteTemporal.getCodigoCliente());
						consultarEquipoFrioActivity.putExtra(ProfitHistoryActivity.CLIENTE_KEY,clienteTemporal.getRazonSocial());
			...
			holder.imgConsultarEncuesta.setOnClickListener(new OnClickListener() {
				ClienteResumenTO clienteTemporal = (ClienteResumenTO) getItem(position);
				...
				public void onClick(View v) {
					...
					consultarEncuestas.putExtra(ProfitHistoryActivity.CODIGO_CLIENTE_KEY,clienteTemporal.getCodigoCliente());
					consultarEncuestas.putExtra(ProfitHistoryActivity.CLIENTE_KEY,clienteTemporal.getRazonSocial());
		...
		static class ViewHolder {
			...
			ImageButton imgConsultarEncuesta;
		}
