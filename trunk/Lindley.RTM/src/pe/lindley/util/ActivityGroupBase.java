...
public class ActivityGroupBase extends RoboActivityGroup {

	protected ProgressDialog dialogWait;
	@Inject 																protected Provider<Context> contextProvider;
	@InjectResource(pe.lindley.activity.R.string.error_not_network_message) protected String error_not_network_message; 
	@InjectResource(pe.lindley.activity.R.string.wait_message) 				protected String wait_message;
	@InjectResource(pe.lindley.activity.R.string.error_generico_process) 	protected String error_generico_process;
