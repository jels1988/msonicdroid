...
public class ResumenJefeComercialesActivity extends net.msonic.lib.sherlock.ActivityBase implements ActionBar.TabListener  {
	
	public static final String NOMBRE_CDA_KEY="NOMBRE_CDA";
	public static final String CODIGO_DEPOSITO_KEY = "CODIGO_DEPOSITO";
	public static final String CODIGO_JEFE_COMERCIAL_KEY = "CODIGO_JEFE_COMERCIAL";
	
	@InjectExtra(CODIGO_JEFE_COMERCIAL_KEY) String codigoJefeComercial;
	...
	@Inject ResumenJefeComercialesProxy resumenJefeComercialesProxy;
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setTitle(R.string.resumen_jefecomercial_activity_title);
  ...
  @Override
	protected void process() {
		// TODO Auto-generated method stub
	  resumenJefeComercialesProxy.codigoDeposito=codigoCda;
	  resumenJefeComercialesProxy.codigoSupervisor=codigoJefeComercial;
	  resumenJefeComercialesProxy.execute();
  ...
  @Override
	protected void processOk() {
		...
		boolean isExito = resumenJefeComercialesProxy.isExito();
		if (isExito) {
			int status = resumenJefeComercialesProxy.getResponse().getStatus();
			if (status == 0) {
				
				ArrayList<ResumenVentaTO> resumenVenta = resumenJefeComercialesProxy.getResponse().detalle.resumen;
				ResumenVenta_Adapter adapterResumen = new ResumenVenta_Adapter(this, resumenVenta);
				lstResumen.setAdapter(adapterResumen);
				
				ArrayList<ResumenVentaDetalleTO> resumenVentaDetalle = resumenJefeComercialesProxy.getResponse().detalle.detalle;
				...
				message = resumenJefeComercialesProxy.getResponse().getDescripcion();
				super.processOk();
				showToast(message);
			}
	...
	protected void processError() {
		String message;
		if(resumenJefeComercialesProxy.getResponse()!=null){
			String error = resumenJefeComercialesProxy.getResponse().getDescripcion();
			message = error;
		}else{
