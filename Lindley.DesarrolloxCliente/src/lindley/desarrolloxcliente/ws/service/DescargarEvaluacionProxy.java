...
import lindley.desarrolloxcliente.ws.bean.DescargarEvaluacionResponse;
import net.msonic.lib.JSONHelper;
import net.msonic.lib.ProxyBase;

public class DescargarEvaluacionProxy extends ProxyBase<DescargarEvaluacionResponse> {
	...
	@Override
	protected DescargarEvaluacionResponse responseText(String json) {
		// TODO Auto-generated method stub
		DescargarEvaluacionResponse response = JSONHelper.desSerializar(json, DescargarEvaluacionResponse.class);
		return response;
	}
