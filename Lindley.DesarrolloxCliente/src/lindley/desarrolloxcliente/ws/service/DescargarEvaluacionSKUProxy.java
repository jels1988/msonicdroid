...
import lindley.desarrolloxcliente.ws.bean.DescargarEvaluacionSkuResponse;
import net.msonic.lib.JSONHelper;
import net.msonic.lib.ProxyBase;

public class DescargarEvaluacionSKUProxy extends ProxyBase<DescargarEvaluacionSkuResponse>{
	...
	protected String getUrl() {
		...
		return urlWS + "/downEvaluacionSKU";
	}
	...
	@Override
	protected DescargarEvaluacionSkuResponse responseText(String json) {
		// TODO Auto-generated method stub
		DescargarEvaluacionSkuResponse response = JSONHelper.desSerializar(json, DescargarEvaluacionSkuResponse.class);
		return response;
	}
